...
class MapSceneCodecTest {
    ...
    fun `serialize and deserialize preserve map fog and token state`() {
        val state = MapSceneState(
            dynamicMapBundlePath = "C:\\maps\\cave.dynamicmap",
            dynamicMapDisplayPath = "C:\\maps\\cave.dynamicmap",
    ...
    fun `serialize stores whichever fog cell list is shorter`() {
        val state = MapSceneState(
            dynamicMapBundlePath = null,
            dynamicMapDisplayPath = null,
            mapImageUri = null,
            mapDisplayPath = null,
        ...
        assertTrue(serialized.contains("dynamicMap.renderMode=RENDER"))
    }
