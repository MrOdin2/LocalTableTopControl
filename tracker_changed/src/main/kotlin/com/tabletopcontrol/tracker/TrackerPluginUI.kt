...
import com.tabletopcontrol.tracker.TrackerPlugin.CONSTANTS.CARD_STYLE_ACTIVE
import com.tabletopcontrol.tracker.TrackerPlugin.CONSTANTS.CARD_STYLE_NORMAL
import com.tabletopcontrol.tracker.TrackerPlugin.CONSTANTS.HORIZONTAL_LAYOUT_RATIO_THRESHOLD
import com.tabletopcontrol.tracker.TrackerPlugin.CONSTANTS.SLIDER_VALUE_EPSILON
import com.tabletopcontrol.tracker.TrackerPlugin.CONSTANTS.TOKEN_COLORS
import com.tabletopcontrol.tracker.TrackerPlugin.TokenImageSettings
...
class TrackerPluginUI(
    val tracker: InitiativeTracker,
    var tokenColorIndex: Int,
    val tokenIds: MutableList<String>,
    val tokenColors: MutableMap<String, Color>,
    val tokenImages: MutableMap<String, TokenImageSettings>
) : Pane() {

    private val tokenImageUtility = TokenImageUtility()

    //methodResponsibility: UI Construction & Layout
    fun createView(): Node {
     ...
     */
    //methodResponsibility: UI Construction & Layout, Drag-and-Drop/Reordering
     ...
     * @param refresh     callback invoked after any structural model change.
     */
    //methodResponsibility: UI Construction & Layout, Drag-and-Drop/Reordering, Token Image Handling, Preset Library Management, EventBus Synchronization
    ...
    //DIALOGS
    //methodResponsibility: Token Image Handling, UI Construction & Layout
    private fun showTokenImageDialog(owner: javafx.stage.Window?, initial: TokenImageSettings): TokenImageSettings? {
        ...
        tokenImageUtility.loadImage(working.uri)
        ...
        val clearBtn = Button("Clear Image").apply {
            ...
            setOnAction {
                ...
                tokenImageUtility.loadImage(null, working)
                isDisable = true
            }
        }
        ...
        val chooseBtn = Button("Choose Image…").apply {
            setOnAction {
                ...
                if (file != null) {
                    ...
                    if (tokenImageUtility.loadImage(uri)) {
     ...
     */
    //methodResponsibility: Preset Library Management, UI Construction & Layout
    ...
    //methodResponsibility: Utility/Formatting
